...
using Owin;
using Magazzino27.Models;

namespace Magazzino27.Account
{
        ...
        protected void Page_Load()
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (message != null)
                {
                    ...
                    SuccessMessage =
                        message == "ChangePwdSuccess" ? "La password è stata cambiata."
                        : message == "SetPwdSuccess" ? "La password è stata impostata."
                        : message == "RemoveLoginSuccess" ? "L'account è stato rimosso."
                        : message == "AddPhoneNumberSuccess" ? "Il numero di telefono è stato aggiunto"
                        : message == "RemovePhoneNumberSuccess" ? "Il numero di telefono è stato rimosso"
                        : String.Empty;
